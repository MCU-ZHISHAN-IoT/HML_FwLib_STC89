 ...
 * @Parameter:(1)time:Initial value of time (time/us)
 ...
 * @Parameter:(1)tc:custom config reference info.,look up details in header file
 * @Ret-val:
 * @Note:config timer_2
 */
 ...
 * @Parameter:(1)a:expected action,decide disable or enable timer intterupt
 * @Ret-val:
...
/*
 * @Protype:void TIM2_INT_setPriority(INTR_priority p)
